...
void main() {
  ...
  daftarKodePaket.forEach((kode, data) {
    print("Kode: $kode, Mata Pelajaran: ${data["mata_pelajaran"]}, Tarif: Rp ${data["tarif"]}");
  });
  ...
  if (daftarKodePaket.containsKey(kodePaket)) {
    ...
    print("Siswa $namaSiswa telah mendaftar kursus $mataPelajaran dengan tarif Rp $tarif.");
  } else {
